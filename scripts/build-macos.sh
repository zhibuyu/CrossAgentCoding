...
# =============================================================================
# CrossAgentCoding macOS DMG Build Script
# =============================================================================
# Output: release/CrossAgentCoding-0.0.1.dmg
# =============================================================================
...
echo "============================================"
echo " CrossAgentCoding macOS DMG Build"
echo "============================================"
echo ""
...
if command -v brew >/dev/null 2>&1; then
    CHOICE="$(osascript -e 'button returned of (display dialog "CrossAgentCoding 需要 Node.js 运行。检测到 Homebrew，是否现在自动安装 Node？" buttons {"去官网下载", "自动安装"} default button "自动安装" with title "CrossAgentCoding")' 2>/dev/null)"
    if [ "$CHOICE" = "自动安装" ]; then
...
echo "CrossAgentCoding 需要 Node.js（建议 LTS）。请安装后重新打开本应用。"
echo "CrossAgentCoding requires Node.js (LTS recommended). Please install it and reopen."
osascript -e 'display dialog "CrossAgentCoding 需要 Node.js 运行。请安装 Node（建议 LTS）后重试。即将打开 nodejs.org。" buttons {"好"} default button 1 with title "CrossAgentCoding"' >/dev/null 2>&1 || true
...
<dict>
    ...
    <string>com.crossagentcoding.app</string>
    <key>CFBundleInfoDictionaryVersion</key>
    <string>6.0</string>
    <key>CFBundleName</key>
    <string>CrossAgentCoding</string>
